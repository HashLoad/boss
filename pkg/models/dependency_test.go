...
func TestDependency_Name(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dep := models.Dependency{Repository: tt.repository}
			result := dep.Name()
...
func TestDependency_HashName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			dep2 := models.Dependency{Repository: tt.repository}
			hash2 := dep2.HashName()
			if hash != hash2 {
	...
	t.Run("different repositories produce different hashes", func(t *testing.T) {
		dep1 := models.Dependency{Repository: "github.com/user/repo1"}
		dep2 := models.Dependency{Repository: "github.com/user/repo2"}
...
func TestDependency_GetVersion(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dep := models.ParseDependency("github.com/test/repo", tt.info)
...
func TestParseDependency(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			dep := models.ParseDependency(tt.repo, tt.info)
...
func TestGetDependencies(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := models.GetDependencies(tt.deps)
...
func TestGetDependenciesNames(t *testing.T) {
	...
	names := models.GetDependenciesNames(deps)
