...
type Repository interface {
	CloneCache(dep models.Dependency) *goGit.Repository
	UpdateCache(dep models.Dependency) *goGit.Repository
	GetVersions(repository *goGit.Repository, dep models.Dependency) []*plumbing.Reference
	...
	GetRepository(dep models.Dependency) *goGit.Repository
}
...
func (d *DefaultRepository) CloneCache(dep models.Dependency) *goGit.Repository {
	return CloneCache(dep)
}

// UpdateCache updates a cached dependency.
func (d *DefaultRepository) UpdateCache(dep models.Dependency) *goGit.Repository {
	return UpdateCache(dep)
}

// GetVersions retrieves all versions (tags and branches) for a repository.
func (d *DefaultRepository) GetVersions(repository *goGit.Repository, dep models.Dependency) []*plumbing.Reference {
...
func (d *DefaultRepository) GetRepository(dep models.Dependency) *goGit.Repository {
