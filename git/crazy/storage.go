// Package crazy is a storage backend base on filesystems
package crazy
...
type Options struct {
	// ExclusiveAccess means that the crazy is not modified externally
...
// Filesystem returns the underlying crazy
