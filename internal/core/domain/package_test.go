...
func TestLoadPackageOther_ValidPackage(t *testing.T) {
	...
	pkg, err := domain.LoadPackageOther(pkgPath)
	if err != nil {
...
func TestLoadPackageOther_NonExistentFile(t *testing.T) {
	...
	pkg, err := domain.LoadPackageOther(filepath.Join(tempDir, "nonexistent.json"))
	if err == nil {
...
func TestLoadPackageOther_InvalidJSON(t *testing.T) {
	...
	_, err = domain.LoadPackageOther(invalidPath)
	if err == nil {
...
func TestLoadPackageOtherWithFS_ValidPackage(t *testing.T) {
	...
	pkg, err := domain.LoadPackageOtherWithFS("/test/boss.json", mockFS)
	if err != nil {
...
func TestLoadPackageOtherWithFS_FileNotFound(t *testing.T) {
	...
	pkg, err := domain.LoadPackageOtherWithFS("/nonexistent/boss.json", mockFS)
	if err == nil {
...
func TestLoadPackageLockWithFS_NewLock(t *testing.T) {
	...
	// No lock file exists
	lock := domain.LoadPackageLockWithFS(pkg, mockFS)
